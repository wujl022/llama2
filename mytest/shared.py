...
lora_names = []
prompt = 'The following is a conversation with an AI Large Language Model. ' \
...
state = {
        ...
        'history': {'internal': [['<|BEGIN-VISIBLE-CHAT|>', 'How can I help you today?']], 'visible': [['', 'How can I help you today?']]},
        'name1': 'You',
        'name2': 'AI',
...
with Path('models//config.yaml') as p:
    if p.exists():
